/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4e67dc33b1da2a3986fd5583d81ef97d)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		AI: Ai;
		STORY_WORKFLOW: Workflow<Parameters<import("./index").StoryAnalyzerWorkflow['run']>[0]['payload']>;
	}
}
