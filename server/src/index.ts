...
app.get('/api/story_bible', async (c) => {
...
app.post('/api/save_bible', async (c) => {
  const db = c.env.plot_armor_db;
  try {
...
app.post('/api/save_text', async (c) => {
  const db = c.env.plot_armor_db;
  try {
...
app.post('/workflow/start_analysis', async (c) => {
...
app.get('/workflow/latest_log', async (c) => {
  const db = c.env.plot_armor_db;  
  try {
